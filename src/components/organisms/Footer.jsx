...
export function Footer() {
  return (
    <footer
      ...
      style={{ background: '#f8fafc', paddingTop: 70, paddingBottom: 34 }}
    >
      <Container>
        <div
        ...
        >
          <div>
            ...
            >
              The Sentinel Archive. Empowering organizations with robust,
        ...
        >
          <p style={{ color: '#94a3b8', fontSize: 12 }}>
            © {new Date().getFullYear()} GovernAI Sentinel Archive. All rights
            reserved.
          </p>
        </div>
      </Container>
