...
function ImageCard() {
    return (
        <>
         <FadeIn delay={0.1} yOffset={30} style={{ textAlign: "center", marginBottom: "20px", marginTop: "60px" }}>
        ...
        <div className="image-holder">
            <FadeIn delay={0.1} yOffset={40} style={{ display: 'flex', flexDirection: 'column', padding: '24px', background: tokens.surface, borderRadius: '24px', boxShadow: '0 12px 40px rgba(0,0,0,0.06)', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'default' }}
            ...
            <FadeIn delay={0.3} yOffset={40} style={{ display: 'flex', flexDirection: 'column', padding: '24px', background: tokens.surface, borderRadius: '24px', boxShadow: '0 12px 40px rgba(0,0,0,0.06)', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'default' }}
                onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-8px)"; e.currentTarget.style.boxShadow = "0 20px 50px rgba(0,0,0,0.12)"; }}
                onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 12px 40px rgba(0,0,0,0.06)"; }}>
            ...
            <FadeIn delay={0.5} yOffset={40} style={{ display: 'flex', flexDirection: 'column', padding: '24px', background: tokens.surface, borderRadius: '24px', boxShadow: '0 12px 40px rgba(0,0,0,0.06)', transition: 'transform 0.3s ease, box-shadow 0.3s ease', cursor: 'default' }}
                onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-8px)"; e.currentTarget.style.boxShadow = "0 20px 50px rgba(0,0,0,0.12)"; }}
                onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 12px 40px rgba(0,0,0,0.06)"; }}>
